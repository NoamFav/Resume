...
use crate::models::projects::{
    Project, ProjectComment, ProjectCommentLike, ProjectContributor, ProjectFramework,
    ProjectImage, ProjectLanguage, ProjectLike, ProjectLink, ProjectRoadmap, ProjectTag,
    ProjectTool,
};
...
pub fn config(cfg: &mut web::ServiceConfig) {
    ...
    cfg.route(
        "/projects/{id}/tags/{tag_id}/update",
        web::put().to(put_project_tag),
    );
    cfg.route(
        "/projects/{id}/tags/{tag_id}/delete",
        web::delete().to(delete_project_tag),
    );

    cfg.route(
        "/projects/{id}/languages",
        web::get().to(get_project_languages),
    );
    cfg.route(
        "/projects/{id}/languages/new",
        web::post().to(post_project_language),
    );
    cfg.route(
        "/projects/{id}/languages/{language_id}/update",
        web::put().to(put_project_language),
    );
    cfg.route(
        "/projects/{id}/languages/{language_id}/delete",
        web::delete().to(delete_project_language),
    );

    cfg.route(
        "/projects/{id}/frameworks",
        web::get().to(get_project_frameworks),
    );
    cfg.route(
        "/projects/{id}/frameworks/new",
        web::post().to(post_project_framework),
    );
    cfg.route(
        "/projects/{id}/frameworks/{framework_id}/update",
        web::put().to(put_project_framework),
    );
    cfg.route(
        "/projects/{id}/frameworks/{framework_id}/delete",
        web::delete().to(delete_project_framework),
    );

    cfg.route("projects/{id}/tools", web::get().to(get_project_tools));
    cfg.route("projects/{id}/tools/new", web::post().to(post_project_tool));
    cfg.route(
        "projects/{id}/tools/{tool_id}/update",
        web::put().to(put_project_tool),
    );
    cfg.route(
        "projects/{id}/tools/{tool_id}/delete",
        web::delete().to(delete_project_tool),
    );

    cfg.route(
        "projects/{id}/contributors",
        web::get().to(get_project_contributors),
    );
    cfg.route(
        "projects/{id}/contributors/new",
        web::post().to(post_project_contributor),
    );
    cfg.route(
        "projects/{id}/contributors/{contributor_id}/update",
        web::put().to(put_project_contributor),
    );
    cfg.route(
        "projects/{id}/contributors/{contributor_id}/delete",
        web::delete().to(delete_project_contributor),
    );

    cfg.route("projects/{id}/links", web::get().to(get_project_links));
    cfg.route("projects/{id}/links/new", web::post().to(post_project_link));
    cfg.route(
        "projects/{id}/links/{link_id}/update",
        web::put().to(put_project_link),
    );
    cfg.route(
        "projects/{id}/links/{link_id}/delete",
        web::delete().to(delete_project_link),
    );

    cfg.route("projects/{id}/images", web::get().to(get_project_images));
    cfg.route(
        "projects/{id}/images/new",
        web::post().to(post_project_image),
    );
    cfg.route(
        "projects/{id}/images/{image_id}/update",
        web::put().to(put_project_image),
    );
    cfg.route(
        "projects/{id}/images/{image_id}/delete",
        web::delete().to(delete_project_image),
    );

    cfg.route("projects/{id}/likes", web::get().to(get_project_likes));
    cfg.route("projects/{id}/likes/new", web::post().to(post_project_like));
    cfg.route(
        "projects/{id}/likes/{like_id}/delete",
        web::delete().to(delete_project_like),
    );

    cfg.route(
        "projects/{id}/comments",
        web::get().to(get_project_comments),
    );
    cfg.route(
        "projects/{id}/comments/new",
        web::post().to(post_project_comment),
    );
    cfg.route(
        "projects/{id}/comments/{comment_id}/update",
        web::put().to(put_project_comment),
    );
    cfg.route(
        "projects/{id}/comments/{comment_id}/delete",
        web::delete().to(delete_project_comment),
    );

    cfg.route(
        "projects/{id}/comments/{comment_id}/likes",
        web::get().to(get_project_comment_likes),
    );
    cfg.route(
        "projects/{id}/comments/{comment_id}/likes/new",
        web::post().to(post_project_comment_like),
    );
    cfg.route(
        "projects/{id}/comments/{comment_id}/likes/{like_id}/delete",
        web::delete().to(delete_project_comment_like),
    );

    cfg.route(
        "projects/{id}/roadmaps",
        web::get().to(get_project_roadmaps),
    );
    cfg.route(
        "projects/{id}/roadmaps/new",
        web::post().to(post_project_roadmap),
    );
    cfg.route(
        "projects/{id}/roadmaps/{roadmap_id}/update",
        web::put().to(put_project_roadmap),
    );
    cfg.route(
        "projects/{id}/roadmaps/{roadmap_id}/delete",
        web::delete().to(delete_project_roadmap),
    );
}
...
async fn get_projects(pool: Data<DbPool>) -> impl Responder {
    ...
    let project_tags = {
        ...
        match ProjectTag::all(&mut conn) {
            Ok(tags) => tags,
            Err(_) => {
                return HttpResponse::InternalServerError().body("Failed to load project tags")
            }
        }
    };
    ...
    let project_languages = {
        ...
        match ProjectLanguage::all(&mut conn) {
            ...
            Err(_) => {
                return HttpResponse::InternalServerError().body("Failed to load project languages")
            }
        }
    };
        ...
        match ProjectFramework::all(&mut conn) {
            ...
            Err(_) => {
                return HttpResponse::InternalServerError()
                    .body("Failed to load project frameworks")
            }
        }
    };
    ...
    let project_tools = {
        ...
        match ProjectTool::all(&mut conn) {
            Ok(tools) => tools,
            Err(_) => {
                return HttpResponse::InternalServerError().body("Failed to load project tools")
            }
        }
    };
    ...
    let project_contributors = {
        ...
        match ProjectContributor::all(&mut conn) {
            ...
            Err(_) => {
                return HttpResponse::InternalServerError()
                    .body("Failed to load project contributors")
            }
        }
    };
    ...
    let project_links = {
        ...
        match ProjectLink::all(&mut conn) {
            Ok(links) => links,
            Err(_) => {
                return HttpResponse::InternalServerError().body("Failed to load project links")
            }
        }
    };
    ...
    let project_images = {
        ...
        match ProjectImage::all(&mut conn) {
            Ok(images) => images,
            Err(_) => {
                return HttpResponse::InternalServerError().body("Failed to load project images")
            }
        }
    };
    ...
    let project_roadmaps = {
        ...
        match ProjectRoadmap::all(&mut conn) {
            ...
            Err(_) => {
                return HttpResponse::InternalServerError().body("Failed to load project roadmaps")
            }
        }
    };
...
fn merge_projects(
    ...
    for project in projects {
        let project_tags = tags
            .iter()
            .filter(|t| t.project_id == project.project_id)
            .collect::<Vec<_>>();
        let project_languages = languages
            .iter()
            .filter(|l| l.project_id == project.project_id)
            .collect::<Vec<_>>();
        let project_frameworks = frameworks
            .iter()
            .filter(|f| f.project_id == project.project_id)
            .collect::<Vec<_>>();
        let project_tools = tools
            .iter()
            .filter(|t| t.project_id == project.project_id)
            .collect::<Vec<_>>();
        let project_contributors = contributors
            .iter()
            .filter(|c| c.project_id == project.project_id)
            .collect::<Vec<_>>();
        let project_links = links
            .iter()
            .filter(|l| l.project_id == project.project_id)
            .collect::<Vec<_>>();
        let project_images = images
            .iter()
            .filter(|i| i.project_id == project.project_id)
            .collect::<Vec<_>>();
        let project_roadmaps = roadmaps
            .iter()
...
async fn get_project_by_id(pool: Data<DbPool>, id: Path<i32>) -> impl Responder {
    ...
    let project_likes = {
        ...
        match ProjectLike::find_by_project_id(projects_id, &mut conn) {
            Ok(likes) => likes,
            Err(_) => {
                return HttpResponse::InternalServerError().body("Failed to load project likes")
            }
        }
    };
    ...
    let project_comments = {
        ...
        match ProjectComment::find_by_project_id(projects_id, &mut conn) {
            ...
            Err(_) => {
                return HttpResponse::InternalServerError().body("Failed to load project comments")
            }
        }
    };
    ...
    let project_comment_likes = {
        ...
        match ProjectCommentLike::find_by_project_id(projects_id, &mut conn) {
            ...
            Err(_) => {
                return HttpResponse::InternalServerError()
                    .body("Failed to load project comment likes")
            }
        }
    };
...
fn merge_project(
    ...
    let project_images = images
        ...
        .filter(|i| i.project_id == project.project_id)
        .collect::<Vec<_>>();
    let project_likes = likes
        .iter()
        .filter(|like| like.project_id == project.project_id)
        .collect::<Vec<_>>();
    let project_comments = comments
        .iter()
        .filter(|c| c.project_id == project.project_id)
        .collect::<Vec<_>>();
    let project_comment_likes = comment_likes
        .iter()
        .filter(|cl| cl.like_id == project.project_id)
        .collect::<Vec<_>>();
    let project_roadmaps = roadmaps
        .iter()
        .filter(|r| r.project_id == project.project_id)
